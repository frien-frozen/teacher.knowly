                    ...
                    {session ? (
                        <div className="relative" ref={dropdownRef}>
                            <button
                                ...
                                className="flex items-center gap-2 pl-1.5 pr-3 py-1.5 bg-[#F3F4F6] hover:bg-gray-200 text-gray-700 rounded-full font-bold text-sm border border-gray-200 transition-all"
                            >
                                <div className="w-7 h-7 rounded-full bg-[#D92D20] flex items-center justify-center text-white text-xs font-black shrink-0">
                                    {session.name?.[0]?.toUpperCase() || <User className="w-3.5 h-3.5" />}
                                </div>
